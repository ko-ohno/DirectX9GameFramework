...
bool SpriteShader::Init(const LPDIRECT3DDEVICE9& lpd3d_device)
{
	...
	*/
	...
	//tmp_vertex[0] = { D3DXVECTOR3(-50.0f,  50.0f, 0.0f), D3DCOLOR_RGBA(255, 255, 255, 255), D3DXVECTOR2(0.f, 0.f) };
	//tmp_vertex[1] = { D3DXVECTOR3( 50.0f,  50.0f, 0.0f), D3DCOLOR_RGBA(255, 255, 255, 255), D3DXVECTOR2(1.f, 0.f) };
	//tmp_vertex[2] = { D3DXVECTOR3(-50.0f, -50.0f, 0.0f), D3DCOLOR_RGBA(255, 255, 255, 255), D3DXVECTOR2(0.f, 1.f) };
	//tmp_vertex[3] = { D3DXVECTOR3( 50.0f, -50.0f, 0.0f), D3DCOLOR_RGBA(255, 255, 255, 255), D3DXVECTOR2(1.f, 1.f) };
...
void SpriteShader::Draw(const LPDIRECT3DDEVICE9& lpd3d_device)
{
	...
	const float pivot = 50.f;
	const float posX  = 100.f;
	const float posY  = 0.f;

	D3DXMatrixIdentity(&world_matrix_);
	world_matrix_._41 = posX + pivot;
	world_matrix_._42 = posY + pivot;
	...
	lpd3d_device->SetStreamSource(0, vertex_buffer_, 0, sizeof(VERTEX_2D));
